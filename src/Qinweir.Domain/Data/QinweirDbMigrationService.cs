...
{
    public class QinweirDbMigrationService : ITransientDependency
    {
        public ILogger<QinweirDbMigrationService> Logger { get; set; }

        private readonly IDataSeeder _dataSeeder;
        private readonly IEnumerable<IQinweirDbSchemaMigrator> _dbSchemaMigrators;
        private readonly ITenantRepository _tenantRepository;
        private readonly ICurrentTenant _currentTenant;

        public QinweirDbMigrationService(
            IDataSeeder dataSeeder,
            IEnumerable<IQinweirDbSchemaMigrator> dbSchemaMigrators,
            ...
            ICurrentTenant currentTenant)
        {
            ...
            Logger = NullLogger<QinweirDbMigrationService>.Instance;
        }
